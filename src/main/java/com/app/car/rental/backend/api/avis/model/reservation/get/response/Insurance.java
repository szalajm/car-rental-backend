...
public class Insurance {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("code", code).append("name", name).append("amount", amount).append("taxIncluded", taxIncluded).append("totalOwed", totalOwed).append("selected", selected).append("selectionNote", selectionNote).append("additionalProperties", additionalProperties).toString();
    }
