...
public class Features {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("bluetoothEquipped", bluetoothEquipped).append("smokeFree", smokeFree).append("airConditioned", airConditioned).append("connectedCar", connectedCar).append("additionalProperties", additionalProperties).toString();
    }
